...
// Testimonial videos show a poster + play button; native controls only appear
// once the viewer starts it. Starting one pauses any other.
document.querySelectorAll('[data-cular-video]').forEach((player) => {
	...
	// Bring the button back when it finishes, so the poster reads as a card again.
