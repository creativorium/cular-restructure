<?php
/**
 * Shared web form steps (2-5): Business, Domain & Hosting, Details, Review.
 * Included by intake-form-web-design.php and intake-form-web-development.php
 * (and the legacy intake-form-web.php). Step 1 (service choice) is defined
 * per-template so each form can offer a tailored service list.
 */
if (!defined('ABSPATH')) {
    exit;
}
